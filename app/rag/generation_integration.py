...
class GenerationIntegrationModule:
    ...
    def __init__(self, model_key: str, model_name: str = "kimi-k2-0711-preview", temperature: float = 0.1, max_tokens: int = 2048):
        """
        初始化生成集成模块
    ...
    def setup_llm(self):
        ...
        api_key = self.model_key or os.getenv("MOONSHOT_API_KEY")
        if not api_key:
