...
const isChatRoute = computed(() => route.path.startsWith("/user/chat"));

const menuItems = [
  { index: "/user/chat", label: "AI 聊天", icon: "💬" },
  { index: "/user/mental/analyze", label: "心理分析", icon: "🧠" },
  { index: "/user/profile", label: "个人信息", icon: "👤" },
];
